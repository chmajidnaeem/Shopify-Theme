      ...
      <Wrapper>
        <div className='stricky top-0 bg-white fixed left-0 right-0 z-10 py-2 sm:px-10 px-0'>
          <div className='flex justify-between items-center'>
            <Image className='' src={LogoFull} alt='' width={150} height={150}></Image>
            <div>
                ...
                <div className="flex" onClick={() => {
                  ...
                  <Link className="flex gap-2" href={'/'}>Shop
                    <svg
                      ...
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      className={toggle ? 'rotate-180 mt-2.5 h-3 w-3 transform transition-transform duration-200 ease-in-out' : 'rotate-0 mt-2.5 h-3 w-3 transform transition-transform duration-200 ease-in-out'}>
                      <path
            ...
            <div className='md:flex hidden gap-5 align-center'>
              <div className="searchBox">
                <input className="searchInput" type="text" name="" placeholder="Search Here!"></input>
              ...
              <div className='pt-2'>
                {showSidebar ? (
                  ...
                  <div className="fixed z-30 flex items-center cursor-pointer right-10 top-6" onClick={() => setShowSidebar(!showSidebar)}>
                    <IoCartOutline size={30} /><sup>0</sup>
                  </div>
                )}

                <div
                  className={`top-0 right-0 w-[25vw] bg-white py-4 px-4 border-l-4 border-[#c1e502] fixed h-full z-40 ease-in-out duration-300 ${showSidebar ? "translate-x-0" : "translate-x-full"
                    }`}
                >
                  <Image className='' src={LogoFull} alt='' width={150} height={150}></Image>
