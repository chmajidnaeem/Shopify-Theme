          ...
          <div className="flex justify-between items-center">
            ...
            <div className="md:flex hidden gap-5 align-center">
              <form action="" className="relative w-max">
                <input
                  type="search"
                  className="peer relative z-12 h-12 w-12 cursor-pointer rounded-full border bg-transparent pl-12 outline-none focus:w-full focus:cursor-text focus:border-[#c1e502] focus:pl-16 focus:pr-4"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className=" peer cursor-pointer absolute inset-y-0 my-auto h-8 w-12 peer-focus:border-r border-transparent stroke-gray-500 px-3.5 peer-focus:border-[#c1e502] peer-focus:stroke-[#c1e502]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <div className="pt-2">
                <FaShoppingCart size={20}  className={"text-green"}/>
              </div>
              ...
              <div
                className={`top-0 right-0 w-[25vw] bg-white py-10 px-4 border-l-4 border-[#c1e502] fixed h-full z-40 ease-in-out duration-300 ${
