      ...
      <Wrapper>
        ...
        <div className="mt-10 grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-5">
          ...
          <div className={`hover: visible `}>
            ...
            {/* <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-white bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-40"> */}
          ...
          <div className=" my-5 md:my-0">
            ...
            <button className="text-black bg-[#c1e502] px-6 py-2 hover:bg-black hover:text-white duration-500 transform mx-20">
              Learn More
            </button>
          </div>
