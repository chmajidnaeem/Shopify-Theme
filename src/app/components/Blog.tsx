    ...
    <div>
      ...
      <div className="flex mt-40 ">
        ...
        <div className="w-[500px] pl-12">
          <div>
            <div className="w-[300px] h-[60px] bg-gray flex justify-start items-center border-l-green">
              <h4 className="text-xl font-bold pl-6">Tags</h4>
            </div>
            <div className="grid grid-cols-2 mt-5 pl-2 pr-24 gap-5">
              <button className="py-3 border-black bg-gray justify-start flex px-4 text-lg font-semibold">
                Equipments
              </button>
              <button className="font-semibold py-3 border-black bg-gray justify-start flex px-4 text-lg">
                Workout
              </button>
              <button className="py-3 border-black bg-gray justify-start flex px-4 text-lg font-semibold">
                Tarining
            ...
            <div className="w-[300px] h-[60px] bg-gray flex justify-start items-center border-l-green mt-16">
            ...
            <div className="flex justify-start mt-8">
              ...
              <div className="pl-5 mt-5">
                ...
                <p className="text-xl font-medium">Make yourself more define</p>
              </div>
            </div>
            <div className="flex justify-start mt-8">
              <Image width={74} src={Blog201} alt="cp" className="h-[90px]" />
            ...
            <div className="flex justify-start mt-8">
              ...
              <div className="pl-5 mt-8">
                <p className="text-xl font-medium">High Wasit Yoga Pants</p>
            ...
            <div className="flex justify-start mt-8">
              <Image width={112} src={Blog201} alt="cp" className="h-[112px]" />
              <div className="pl-5 mt-8">
                <p className="text-xl font-medium">Sports Wear Set for Women</p>
                <p className="text-green text-xl">$35.00</p>
              </div>
            </div>
          </div>
